<?php return [
    ...
    'components' => [
        ...
        'units'         => [
            'name'        => 'GetPly Разделы',
            'description' => 'Выводит коллекцию разделов.',
        ],
        'learn'         => [
    ...
    'properties' => [
        ...
        'show_subscriptions_title'         => 'Показать подписки',
        'show_subscriptions_description'   => 'Показывает подписки вместо авторских курсов',
    ],
];